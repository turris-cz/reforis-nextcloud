...
PROJECT="reForis NextCloud Plugin"
...
update-messages:
	$(VENV_BIN)/pybabel update -i ./reforis_nextcloud/translations/messages.pot -d ./reforis_nextcloud/translations --update-header-comment
...
clean:
	...
	$(PYTHON) -m pip uninstall -y reforis_nextcloud
